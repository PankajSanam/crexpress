                    ...
                    <div class="gallery">
                        ...
                        <!-- Col1 -->
                            <div class="categorydiv">
                                <ul>
                                    <li><a class="selected" href="#">College Fun Fair</a></li>
                                    <li><a href="#">College Biulding</a></li>
                                    <li><a href="#">Our International Students</a></li>
                                    <li><a href="#">English Classis</a></li>
                                    <li><a href="#">Mr.Robort Lecture  </a></li>
