			...
			<div class="span9 inner-page">
				<div>
					...
					<div class="software">
						<?php
						$Db = new Db;
						$software_list = $Db->select('software',array('status=' => 1));
						foreach($software_list as $soft) { 
						?>
						<h1><?php echo $soft['name']; ?></h1>
						<p><?php echo $soft['description']; ?></p>
						<div class="software"><span><a href="<?php echo SITE_PATH; ?>/asset/data/software/<?php echo $soft['file'];?>" download="<?php echo $soft['file'];?>">Download</a></span></div>
						<?php } ?>
					</div>
				</div>
			</div>
