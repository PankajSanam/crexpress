				...
				<table class="table table-hover table-nomargin table-bordered dataTable-columnfilter dataTable dataTable-tools dataTable-reorder">
					...
					<tbody>
						...
						<tr>
							...
							<td><img width="100" height="100" src="<?php echo DATA_VIEW; ?>/slider/<?php echo $slider['image']; ?>" /></td>
							...
							<td class='hidden-480'>
								...
								<a href="slider.html?home&delete=<?php echo $encrypt->lock($slider['id']); ?>" onclick="return ConfirmDelete();" class="btn" rel="tooltip" title="Delete">
						...
						<div class="controls">
							<div class="fileupload fileupload-new" data-provides="fileupload">
								<div class="fileupload-new thumbnail" style="width: 200px; height: 150px;">
									...
									?>
									<img src="<?php echo DATA_VIEW; ?>/slider/<?php echo $image; ?>" />
									<?php
									} else {
									?>
