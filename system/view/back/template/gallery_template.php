				...
				<table class="table table-hover table-nomargin table-bordered dataTable-columnfilter dataTable dataTable-tools dataTable-reorder">
					...
					<tbody>
						...
						<tr>
							...
							<td><img width="100" height="100" src="<?php echo DATA_VISION.'/gallery/thumbnail/'.$gallery['gallery_image']; ?>" /></td>
						...
						<div class="controls">
							<div class="fileupload fileupload-new" data-provides="fileupload">
								<div class="fileupload-new thumbnail" style="width: 200px; height: 150px;">
									...
									?>
									<img src="<?php echo DATA_VISION; ?>/gallery/thumbnail/<?php echo $gallery_image; ?>" />
									<?php
									} else {
									?>
