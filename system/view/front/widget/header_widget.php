...
<head>
	...
	<link rel="shortcut icon" href="<?php echo FRONT_VISION ?>/images/favicon.png" type="image/png" />
...
<div class="top-bg">
	<div class="maindiv">
		...
		<div class="social-icon"><?php echo $social->icons(28,28); ?></div>
	</div>
</div>
<div class="clear"></div>
<div class="maindiv">
	...
	<div class="maindiv">
		<div id='cssmenu' >
			<ul>
				...
				?>
				<li>
					<a href="<?php echo page_url($top_menu['slug']); ?>" class="<?php echo $navigation->current_menu($slug,$top_menu['slug']) ?>"><?php echo $top_menu['menu_name']; ?></a>
					<?php
					...
					<ul>
						...
						<li class='has-sub'>
							...
							if(count($submenus) <= 0)
							?>
							<a href="<?php echo page_url($top_submenu['slug']); ?>" class="<?php echo $navigation->current_menu($slug,$top_menu['slug']) ?>"><?php echo $top_submenu['menu_name']; ?></a>
							<?php
							if(count($submenus) > 0){
							?>
							<ul>
								...
								?>
								<li><a href="<?php echo page_url($sub_submenu['slug']); ?>" class="<?php echo $navigation->current_menu($slug,$top_menu['slug']) ?>"><?php echo $sub_submenu['menu_name']; ?></a></li>
