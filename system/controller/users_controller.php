...
class Users_Controller extends Crexo_Controller {
	...
	public function back_index(){
		...
		$this->data['meta_title'] 	=	$this->model['users']->meta_title('Users - GIT BOX');
		$this->data['users']		=	$this->model[$this->slug]->users();
