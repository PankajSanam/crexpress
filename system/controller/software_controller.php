...
class Software_Controller extends Crexo_Controller {
	...
	public function back_index(){
		parent::__construct($this->slug,'','software');
		...
		$this->data['meta_title'] 	=	$this->model[$this->slug]->meta_title('Software - GIT BOX');
		$this->data['software_list']=	$this->model[$this->slug]->softwares();

		$this->data['breadcrumb'] = '
			<li><a href="software.html">Software Management</a><i class="icon-angle-right"></i></li>
			<li><a href="software.html?add">Add Software</a></li>';
