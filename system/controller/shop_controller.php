...
class Shop_Controller extends Crexo_Controller {
	
	public function __construct($page){
		parent::__construct($page,'','shop');
	...
	public function back_index(){
		...
		$this->data['meta_title'] 	=	$this->model['shop']->meta_title('Products - GIT BOX');
		$this->data['products']		=	$this->model[$this->page]->products();
