...
class Jobs_Controller extends Crexo_Controller {
	
	public function __construct($page){
		parent::__construct($page,'','jobs');
	...
	public function back_index(){
		...
		$this->data['meta_title'] 	=	$this->model['jobs']->meta_title('Pages - GIT BOX');
		$this->data['private_jobs']		=	$this->model[$this->page]->private_jobs();
		$this->data['job_categories']	=	$this->model[$this->page]->job_categories();
