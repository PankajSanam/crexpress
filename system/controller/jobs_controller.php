...
class Jobs_Controller extends Crexo_Controller {
	...
	public function back_index(){
		...
		$this->data['meta_title'] 	=	$this->model['jobs']->meta_title('Jobs - GIT BOX');
		$this->data['private_jobs']		=	$this->model[$this->slug]->private_jobs();
		$this->data['job_categories']	=	$this->model[$this->slug]->job_categories();
