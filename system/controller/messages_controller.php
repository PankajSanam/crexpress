...
class Messages_Controller extends Crexo_Controller {
	...
	public function back_index(){
		...
		$this->data['meta_title'] 	=	$this->model['messages']->meta_title('Pages - GIT BOX');
		$this->data['enquiries']		=	$this->model[$this->page]->enquiries();
		$this->data['total_enquiries']	= 	$this->model[$this->page]->total_enquiries();
