	<div class="col1"> 
        ...
        <div class="listingblock">
			...
			$query = mysql_query("select *from private_jobs where status='1' AND city_id='".$city_id."' ") or die(db_error());
		...
		<div id="content2"> 
			...
			<div class="blog_detail">
			 ...
			 <div class="listingblock">
				...
				$query = mysql_query("select *from private_jobs where status='1' AND job_slug='".$page_slug."' ") or die(db_error());
				$res = mysql_num_rows($query);
