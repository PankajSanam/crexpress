...
{
	/**
	 * Accepts an array of stylesheets where the key of the array
	 * is the path of stylesheet and value of the key will represent
	 * any other additional attributes like media, id etc.
	 *
	 * @param $styles
	 *
	 * @return null|string
	...
	public static function styles($styles)
	{
		...
		{
			$s .= '<link rel="stylesheet" type="text/css" href="' . THEME_DIR.$css . '" ' . $attr . ' />';
			$s .= "\n";
		}
		return $s;
	}
	...
	/**
	 * Accepts an array of javascript files
	 *
	 * @param $scripts
	 *
	 * @return null|string
	...
	public static function scripts($scripts)
	{
		...
		{
			$s .= '<script type="text/javascript" src="' . THEME_DIR.$script . '"></script>';
			$s .= "\n";
		}
		return $s;
	}
	...
	/**
	 * Accepts the content of a script tag
	 *
	 * @param $content
	 *
	 * @return string
