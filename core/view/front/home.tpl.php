...
<section id="content" class="container clearfix">
	...
	<section class="one-third column-last">
		...
		<ul class="thumbs clearfix">
			<li><a href="#" title="Project Title"><img src="{$images}/entries/70x70/canoes-on-moraine-lake-70x70.png" alt=""></a></li>
			<li><a href="#" title="Project Title"><img src="{$images}/entries/70x70/spring-70x70.png" alt=""></a></li>
			<li><a href="#" title="Project Title"><img src="{$images}/entries/70x70/sailing-70x70.png" alt=""></a></li>
			<li><a href="#" title="Project Title"><img src="{$images}/entries/70x70/sunrise-70x70.png" alt=""></a></li>
			<li><a href="#" title="Project Title"><img src="{$images}/entries/70x70/southern-alps-70x70.png" alt=""></a></li>
			<li><a href="#" title="Project Title"><img src="{$images}/entries/70x70/the-golden-sea-bali-70x70.png" alt=""></a></li>
		</ul>
	</section>
