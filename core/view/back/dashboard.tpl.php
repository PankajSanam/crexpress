				...
				<div class="timeline-scrollable">
					...
					<ul class="timeline">
						<li class="clearfix">
							...
							<img src="{$back_view}img/template/avatar.jpg" alt="Avatar" class="timeline-avatar">
						...
						<li class="clearfix">
							...
							<img src="{$back_view}img/placeholders/image_64x64_dark.png" alt="Avatar" class="timeline-avatar">
						...
						<li class="clearfix">
							...
							<a href="{$back_view}img/placeholders/image_720x450_light.png" data-toggle="lightbox-image"><img src="img/placeholders/image_160x120_light.png" alt="image"></a>
						</li>
						<li class="clearfix">
						...
						<div class="scrollable">
							...
							<div class="media">
								<a href="javascript:void(0)" class="pull-left" data-toggle="tooltip" title="Username">
									<img src="{$back_view}img/placeholders/image_64x64_dark.png" class="media-object img-circle" alt="Image">
								</a>
							...
							<div class="media">
								<a href="javascript:void(0)" class="pull-left" data-toggle="tooltip" title="Username">
									<img src="{$back_view}img/placeholders/image_64x64_light.png" class="media-object img-circle" alt="Image">
								</a>
								<div class="media-body">
									<h5 class="media-heading">
										<a href="javascript:void(0)" class="badge badge-neutral" data-toggle="tooltip" title="Reply"><i class="icon-reply"></i></a>
		...
		<div class="block-content">
			<div class="gallery" data-toggle="lightbox-gallery">
				<div class="row-fluid row-items">
					<div class="span2">
						<a href="{$back_view}img/placeholders/image_720x450_dark.png" class="gallery-link">
							<img src="{$back_view}img/placeholders/image_720x450_dark.png" alt="image">
						</a>
					</div>
					<div class="span2">
						<a href="{$back_view}img/placeholders/image_720x450_light.png" class="gallery-link">
							<img src="{$back_view}img/placeholders/image_720x450_light.png" alt="image">
						</a>
					</div>
					<div class="span2">
						<a href="{$back_view}img/placeholders/image_720x450_dark.png" class="gallery-link">
