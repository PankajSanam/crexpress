				...
				<table class="table table-hover table-nomargin table-bordered dataTable-columnfilter dataTable dataTable-tools dataTable-reorder">
					...
					<tbody>
						...
						<tr>
							...
							<td><?php echo Route::template_name($page['page_template_id']); ?></td>
							...
							<td class='hidden-480'>
								<a href="<?php echo ADMIN_PATH; ?>pages/edit/<?php echo $page['id'];?>" class="btn" rel="tooltip" title="Edit"><i class="icon-edit"></i></a>
								<a href="<?php echo ADMIN_PATH; ?>pages/delete/<?php echo $encrypt->lock($page['id']); ?>" onclick="return ConfirmDelete();" class="btn" rel="tooltip" title="Delete">
...
<div class="row-fluid">
	<div class="span12">
		<div class="box box-color box-bordered">
			<div class="box-title"><h3><i class="icon-th-list"></i> Edit Page</h3></div>
			<div class="box-content nopadding">
				<?php
					...
					<div class="tab-content nopadding tab-content-inline tab-content-bottom">
							...
							<div class="span12">
								<div class="span6">
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" name="title" id="title" value="<?php if( get('edit') ) echo $title; ?>" class="input-xlarge" data-rule-required="true" data-rule-minlength="2">
										...
										<div class="controls_">
											<div class="fileupload fileupload-new" data-provides="fileupload">
												<div class="fileupload-new thumbnail" style="width: 130px; height: 100px;">
													<?php if( get('edit') && $featured_image!='') { ?>
								...
								<div class="control-group">
									...
									<div class="controls" style="float:left">
										...
										<textarea name="content" class='ckeditor span12' rows="5" data-rule-required="true" data-rule-minlength="2"><?php if( get('edit') ) echo $content; ?></textarea>
									</div>
								</div>
						...
						<div class="tab-pane" id="menuoption">
							<div class="control-group">
								...
								<div class="controls">
									<input type="text" name="menu_name" id="menu_name" value="<?php if( get('edit') ) echo $menu_name; ?>" class="input-large" data-rule-required="true" data-rule-minlength="2" />
								</div>
							</div>
							<div class="control-group">
								<label for="menu_name_alt" class="control-label">Alternative Menu Name</label>
								<div class="controls">
									<input type="text" name="menu_name_alt" id="menu_name_alt" value="<?php if( get('edit') ) echo $menu_name_alt; ?>" class="input-large" data-rule-required="true" data-rule-minlength="2" />
								</div>
							</div>
							<div class="control-group">
								<label for="menu_sort_order" class="control-label">Menu Sort Order</label>
								<div class="controls">
									<input type="text" name="menu_sort_order" id="menu_sort_order" value="<?php if( get('edit') ) echo $menu_sort_order; ?>" class="input-small" data-rule-required="true" data-rule-minlength="2" />
								</div>
							</div>
							<div class="control-group">
						...
						<div class="tab-pane" id="seo">
							<div class="control-group">
								...
								<div class="controls">
									<input type="text" name="slug" id="slug" value="<?php if( get('edit') ) echo $slug; ?>" class="input-xlarge" data-rule-required="true" />
							...
							<div class="control-group">
								...
								<div class="controls">
									<input type="text" name="meta_title" id="meta_title" value="<?php if( get('edit') ) echo $meta_title; ?>" class="input-xlarge" data-rule-required="true" />
							...
							<div class="control-group">
								...
								<div class="controls">
									<textarea name="meta_description" id="meta_description" rows="5" style="width:300px;" class="input-block-level" data-rule-required="true"><?php if( get('edit') ) echo $meta_description; ?></textarea>
							...
							<div class="control-group">
								...
								<div class="controls">
									<div class="span12">
										<input type="text" name="meta_keywords" id="meta_keywords" value="<?php if( get('edit') ) echo $meta_keywords; ?>" class="tagsinput" value="tutorial,education" data-rule-required="true" />
									</div>
								</div>
							</div>
							<div class="form-actions">
								...
								<div class="controls">
									<div class="input-large">
										<select name="page_category_id" id="page_category_id" class='chosen-select'>
											...
											<option value="<?php echo $page_category['id'];?>" <?php if( get('edit') && $page_category_id==$page_category['id']) echo ' selected ';  ?>><?php echo $page_category['menu_name'];?></option>
											<?php } ?>
										</select>
									</div>
								</div>
								...
								<div class="controls">
									<div class="input-medium">
										<select name="page_template_id" id="page_template_id" class='chosen-select input-small'>
											...
											?>
											<option value="<?php echo $page_template['id'];?>" <?php if( get('edit') && $page_template_id==$page_template['id']) echo ' selected ';  ?>><?php echo $page_template['template_name'];?></option>
											<?php } ?>
										</select>
									</div>
								</div>
									...
									<div class="controls">
										<div class="check-demo-col">
											<div class="check-line">
												<input type="radio" id="status" class='icheck-me' name="status" data-skin="square" data-color="blue" value="1" <?php if( get('edit') AND $status==1) echo ' checked '; else echo ' checked';  ?> /> <label class='inline' for="status">Enable</label>
											</div>
											<div class="check-line">
												<input type="radio" id="status" class='icheck-me' name="status" data-skin="square" data-color="blue" value="0" <?php if( get('edit') AND $status==0) echo ' checked '; else echo ''; ?> /> <label class='inline' for="status">Disable</label>
											</div>
										</div>
									</div>
								</div>
			...
			if(isset($_POST['save'])){
				...
				if($page_category!=0) {
					...
					if($_POST['slug']!=''){
						...
						$slug = $sanitize->clean($_POST['title']).$page_cat_slug;
					}
				} else {
					if($_POST['slug']!=''){
						$slug = $sanitize->clean($_POST['slug']);
				...
				if(!empty($_POST['menu_position'])) $menu_position = implode(',',$_POST['menu_position']); else $menu_position = '';
