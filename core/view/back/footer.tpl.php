...
<!--[if lte IE 8]><script src="{$back_view}js/helpers/excanvas.min.js"></script><![endif]-->
...
<!-- Bootstrap.js -->
<script src="{$back_view}js/vendor/bootstrap.min.js"></script>
...
<script src="{$back_view}js/plugins.js"></script>
<script src="{$back_view}js/main.js"></script>
