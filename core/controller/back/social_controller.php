...
class Social_Controller extends Crexo_Controller {
	
	public function __construct($slug){
		parent::__construct($slug,'','social');
	...
	public function back_index(){
		...
		$this->data['meta_title'] 	=	$this->model['social']->meta_title('Social - GIT BOX');
		$this->data['social_icons']	=	$this->model[$this->slug]->social_icons();
