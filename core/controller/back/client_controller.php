...
class Client_Controller extends Crexo_Controller 
{
	...
	public function back_index()
	{
		...
		$this->data['meta_title'] 	=	meta_title('Client Logo - CrexPress');
		$this->data['client_logos']	=	$model->client();

		$this->data['breadcrumb'] = '
			<li><a href="'.ADMIN_PATH.'client/">Client Logo Management</a><i class="icon-angle-right"></i></li>
			<li><a href="'.ADMIN_PATH.'client/add/">Add Client Logo</a></li>
		';

		if( get('edit') ){
			$this->data['edit_data']	= 	$model->edit_data(get('edit'));
		} else {
			$this->data['edit_data'] 	= 	$model->edit_data(1);
		}
