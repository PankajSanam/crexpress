...
class Messages_Controller extends Crexo_Controller {
	...
	public function back_index(){
		...
		$this->data['meta_title'] 	=	$this->model['messages']->meta_title('Messages - GIT BOX');
		$this->data['enquiries']		=	$this->model[$this->slug]->enquiries();
		$this->data['total_enquiries']	= 	$this->model[$this->slug]->total_enquiries();
		$this->data['breadcrumb'] = '<li><a href="messages.html">Messages</a></li>';
