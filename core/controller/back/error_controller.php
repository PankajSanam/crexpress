...
class Error_Controller extends Crexo_Controller {
	public $page;

	public function __construct($slug){
		parent::__construct($slug,'error');

		$this->model['error'] = Route::back_model('error');
	...
	public function back_index(){
		...
		$this->data['meta_title']	=	$this->model['error']->meta_title('404 Not Found - GIT BOX');
		$this->data['body_class']	=	'';
		$this->data['breadcrumb'] = '<li><a href="404.html">Page Not Found</a></li>';
