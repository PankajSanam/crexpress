...
class Slider_Controller extends Crexo_Controller {
	...
	public function back_index(){
		...
		$this->data['meta_title'] 	=	$this->model['slider']->meta_title('Slider - GIT BOX');
		$this->data['sliders']		=	$this->model[$this->slug]->sliders();
		$this->data['slider_categories'] = $this->model[$this->slug]->slider_categories();
