	...
	public function process()
	{
		$this->template->assign(array(
			'resources' => '
			    ...
			    <link rel="stylesheet" type="text/css" href="'.FRONT_VIEW.'css/revslider.css" media="screen">
			    ...
			    <script src="'.FRONT_VIEW.'js/jquery.jcarousel.min.js" type="text/javascript"></script> <!-- carousel -->
			    ...
			    <script type="text/javascript" src="'.FRONT_VIEW.'js/revslider.jquery.themepunch.revolution.js"></script>
			    <!-- REVOLUTION BANNER CSS SETTINGS -->
			    <script src="'.FRONT_VIEW.'js/jquery.fancybox.pack.js" type="text/javascript"></script> <!-- lightbox -->
			    <script src="'.FRONT_VIEW.'js/jquery.fancybox-media.js" type="text/javascript"></script> <!-- lightbox -->
