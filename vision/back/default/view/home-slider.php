...
<div class="container-fluid" id="content">
	...
	<div id="main">
		<div class="container-fluid">
			<div class="page-header"><div class="pull-left"><h1>Home Slider Management</h1></div><?php sub_header(); ?></div>
			<div class="breadcrumbs">
				<ul>
					<li><a href="dashboard.html">Home</a><i class="icon-angle-right"></i></li>
					<li><a href="home-slider.html">Home Slider Management</a><i class="icon-angle-right"></i></li>
								...
								<tbody>
									...
									<tr>
										...
										<td class='hidden-480'>
											...
											<a href="manage-slider.html?action=edit&id=<?php echo $slider['id'];?>" class="btn" rel="tooltip" title="Edit"><i class="icon-edit"></i></a>
