			...
			<div class="row-fluid margin-top">
				<div class="span12">
					<div class="alert alert-info">
						<h4>Greetings Admin!</h4><p>Welcome to GIT BOX, a complete Content 
						Management Framework solution.</p>
					</div>
				</div>
			</div>
			<div class="row-fluid">
								...
								<div class="bottom">
									<ul class="stats-overview">
										<li>
											...
											<span class="value">11,251</span>
										</li>
										<li>
											<span class="name">Pages / Visit</span>
											<span class="value">8.31</span>
										</li>
										<li>
											<span class="name">Avg. Duration</span>
											<span class="value">00:06:41</span>
										</li>
										<li>
											<span class="name">% New Visits</span>
											<span class="value">67,35%</span>
										</li>
									</ul>
								</div>
							</div>
				...
				<div class="span6">
					<div class="box box-color lightred box-bordered">
						<div class="box-title">
							<h3><i class="icon-bar-chart"></i>HDD usage</h3>
							<div class="actions">
								<a href="#" class="btn btn-mini content-refresh"><i class="icon-refresh"></i></a>
								<a href="#" class="btn btn-mini content-remove"><i class="icon-remove"></i></a>
								<a href="#" class="btn btn-mini content-slideUp"><i class="icon-angle-down"></i></a>
						...
						<div class="box-content">
							<div class="statistic-big">
								<div class="top">
									...
									<div class="right">50% <span><i class="icon-circle-arrow-right"></i></span></div>
								</div>
								<div class="bottom"><div class="flot medium" id="flot-hdd"></div></div>
								<div class="bottom">
									<ul class="stats-overview">
										<li>
										...
										<li>
											<span class="name">Usage % / User</span>
											<span class="value">0.031</span>
										</li>
										<li>
											<span class="name">Avg. Usage %</span>
											<span class="value">60%</span>
										</li>
										<li>
											<span class="name">Idle Usage %</span>
					...
					<div class="box">
						...
						<div class="box-content nopadding scrollable" data-height="350" data-visible="true" data-start="bottom">
							<ul class="messages">
								<li class="left">
									<div class="image">
										<img src="<?php echo BACK_VISION; ?>/img/demo/user-1.jpg" alt="">
									</div>
									<div class="message">
								...
								<li class="typing">
									<span class="name">John Doe</span> is typing <img src="<?php echo BACK_VISION; ?>img/loading.gif" alt="">
								</li>
								<li class="insert">
									<form id="message-form" method="POST" action="#">
										...
										<div class="submit"><button type="submit"><i class="icon-share-alt"></i></button></div>
									</form>
								</li>
							</ul>
						</div>
						...
						<div class="box-content nopadding scrollable" data-height="300" data-visible="true">
							<table class="table table-user table-nohead">
								<tbody>
									...
									<tr>
										<td class='img'><img src="<?php echo BACK_VISION; ?>/img/demo/user-1.jpg" alt=""></td>
										<td class='user'>Bi Doe</td>
										<td class='icon'><a href="#" class='btn'><i class="icon-search"></i></a></td>
									</tr>
									<tr>
										<td class='img'><img src="<?php echo BACK_VISION; ?>/img/demo/user-2.jpg" alt=""></td>
									...
									<tr>
										<td class='img'><img src="<?php echo BACK_VISION; ?>/img/demo/user-3.jpg" alt=""></td>
										<td class='user'>Dan Doe</td>
										<td class='icon'><a href="#" class='btn'><i class="icon-search"></i></a></td>
									</tr>
									<tr>
										<td class='img'><img src="<?php echo BACK_VISION; ?>/img/demo/user-4.jpg" alt=""></td>
									...
									<tr>
										<td class='img'><img src="<?php echo BACK_VISION; ?>/img/demo/user-5.jpg" alt=""></td>
										<td class='user'>John Doe</td>
										<td class='icon'><a href="#" class='btn'><i class="icon-search"></i></a></td>
									</tr>
									<tr>
										<td class='img'><img src="<?php echo BACK_VISION; ?>/img/demo/user-6.jpg" alt=""></td>
										<td class='user'>John Doe</td>
										<td class='icon'><a href="#" class='btn'><i class="icon-search"></i></a></td>
									</tr>
									<tr class="alpha">
