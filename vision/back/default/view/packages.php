		...
		<div class="container-fluid">
			...
			<div class="breadcrumbs">
				<ul>
					...
					<li><a href="packages.html">Packages</a><i class="icon-angle-right"></i></li>
								...
								<tbody>
									...
									<tr>
										...
										<td class='hidden-480'>
											...
											<a href="post-private-job.html?action=edit&id=<?php echo $package['id'];?>" class="btn" rel="tooltip" title="Edit"><i class="icon-edit"></i></a>
