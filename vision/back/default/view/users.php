		...
		<div class="container-fluid">
			...
			<div class="breadcrumbs">
				<ul>
					...
					<li><a href="manage-users.html">Add Users</a></li>
				</ul>
								...
								<tbody>
									...
									<tr>
										...
										<td class='hidden-480'>
											...
											<a href="manage-users.html?action=edit&id=<?php echo $user['id'];?>" class="btn" rel="tooltip" title="Edit"><i class="icon-edit"></i></a>
