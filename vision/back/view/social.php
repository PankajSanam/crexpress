		...
		<div class="container-fluid">
			...
			<div class="breadcrumbs">
				<ul>
					...
					<li><a href="social.html?icons">Social Icons Management</a><i class="icon-angle-right"></i></li>
					<li><a href="social.html?icons=add">Add Social Icons</a></li>
				</ul>
				<div class="close-bread"><a href="#"><i class="icon-remove"></i></a></div>
			</div>
			<?php if(isset($_GET['icons']) AND !isset($_GET['id'])) {?>
			<div class="row-fluid">
				<div class="span12">
								...
								<tbody>
									...
									<tr>
										...
										<td class='hidden-480'>
											...
											<a href="social.html?icons&action=edit&id=<?php echo $social_icon['id'];?>" class="btn" rel="tooltip" title="Edit"><i class="icon-edit"></i></a>
										...
										<div class="fileupload fileupload-new" data-provides="fileupload">
											...
											<div>
												...
												if(isset($_POST['remove_image'])){
													...
													$url ='social.html?icons&action=edit&id='.$_GET['id'];
													redirect($url);
												}
												?>
											</div>
