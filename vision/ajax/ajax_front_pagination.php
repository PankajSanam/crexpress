...
require_once '../../retina/core/db.php';
if($_POST['page']) {
	$page = $_POST['page'];
	$cur_page = $page;
	$page -= 1;
		...
		<div class="listing-1">
			<div class="listing-image">
				<div class="listing-logo">
					<a href="'.page_url($college["slug"]).'"><img src="'.DATA_VISION.'/colleges/'.$college["featured_image"].'" width="91" height="66" /></a>
				</div>
			...
			<div class="listing-detail">
				<a href="'.page_url($college['slug']).'">'.$college['title'].'</a>
				<p>'.$college['address'].'</p>
