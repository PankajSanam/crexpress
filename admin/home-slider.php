...
<head>
	...
	<title>GIT BOX - Home Slider</title>
		...
		<div id="main">
			<div class="container-fluid">
				<div class="page-header">
					<div class="pull-left"><h1>Home Slider Management</h1></div>
					<?php sub_header(); ?>
				</div>
				<div class="breadcrumbs">
					<ul>
						<li><a href="dashboard.php">Home</a><i class="icon-angle-right"></i></li>
						<li><a href="home-slider.php">Home Slider Management</a><i class="icon-angle-right"></i></li>
						...
						<div class="box box-color box-bordered">
							...
							<div class="box-content nopadding">
								<table class="table table-hover table-nomargin table-bordered dataTable-columnfilter dataTable dataTable-tools dataTable-reorder">
									...
									<tbody>
										<?php
										$sliders = DB::select_query('sliders');
										...
										<tr>
											...
											<td class='hidden-480'>
												...
												<a href="manage-slider.php?action=edit&id=<?php echo $slider['id'];?>" class="btn" rel="tooltip" title="Edit"><i class="icon-edit"></i></a>
