	...
	<div id="main">
		<div class="container-fluid">
			<div class="page-header">
				<div class="pull-left"><h1>Media manager</h1></div>
			...
			<div class="breadcrumbs">
				<ul>
					...
					<li><a href="plugins-charts.html">Plugins</a><i class="icon-angle-right"></i></li>
			...
			<div class="row-fluid">
				<div class="span12">
					<div class="box">
						<div class="box-title"><h3><i class="icon-file"></i>Media manager</h3></div>
						<div class="box-content nopadding"><div class="file-manager"></div></div>
					</div>
				</div>
			</div>
		</div>
